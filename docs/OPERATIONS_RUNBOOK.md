# newscred-rag: Production Operations Runbook & Incident Playbook

Operational guidelines, SLO definitions, and incident playbooks for **News Credibility Verification & Source Credential Scoring Engine**.
